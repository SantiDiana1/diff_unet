...
def main (args=None):
    ...
    model = load_model("./ckpt_lineal",bestsdr)  
    mus = glob.glob("/home/santi/datasets/musdb_test/*/*/mixture.wav")
    c=0

    reverse_process = ReverseProcess(steps=params.iters,device = "cuda")
    reverse_process.model = model 
    #a=0
    for count,filename in (enumerate(mus)):
        ...
        soundfile.write(f"audios_presentation/carlos_lineal.wav", output_voice, 22050)
